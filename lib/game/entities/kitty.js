...
.defines(function() {
    ...
    EntityKitty = ig.Entity.extend({
        ...
        getSlowedSpeed: function() {
            return (this.speed+10*(ig.game.currentLevelNumber-2))-((1000-ig.game.energy)/20);
        },
        ...
        getSlowedRunningSpeed: function() {
            return (this.speed+25*(ig.game.currentLevelNumber-2))-((1000-ig.game.energy)/20);
        },
        ...
        slow: function() {
            this.slowUntilTime = this.time+50;
        }
